...
const PostForm = () => {
    ...
    const getProduct = async (category) => {
        await axios
            .get(`${GLOBAL_URL}/product/${category}`)
            .then(async (response) => {
    ...
    const fileUpload = async (file, name) => {
        ...
        const storageRef = ref(
            storage,
            `Advertisements/${postData.basic_price}_${postData.description}/${file.name}`
        );
                    ...
                    <li className="nav-item" role="presentation">
                        <div
                            ...
                            className={
                                ...
                                postData?.quantity &&
                                postData?.grad_or_spec &&
                                postData?.quality &&
                                postData?.temper &&
                                postData?.specification_number &&
                                postData?.coating_in_gsm &&
                                postData?.thickness &&
                                postData?.width &&
                                postData?.length &&
                    ...
                    <div className="row">
                        <div className="col-12 mx-3 pr-5">
                            <div className="form-group">
                                ...
                                <select
                                    className="form-control"
                                    value={postData.buy_or_sell}
                                    onChange={(e) =>
                                        setPostData({
                                            ...postData,
                                            buy_or_sell: e.target.value,
                                        })
                                    }
                                    name=""
                                    id="buySell"
            ...
            {active2 ? (
                <div className="container pb-4">
                        ...
                        <div className="col-6">
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    name=""
                                    id="grad-spec"
                                    value={postData.grad_or_spec}
                                    onChange={(e) =>
                                        setPostData({
                                            ...postData,
                                            grad_or_spec: e.target.value,
                                        })
                                    }
                                    placeholder="Grad/Spec"
                                    className="form-control"
                                />
                            </div>
                        </div>
                    ...
                    <div className="row px-3">
                        ...
                        <div className="col-6">
                            <div className="form-group">
                                <label htmlFor="temper">
                                    Temper{" "}
                                    <span className="text-danger">*</span>
                                </label>
                                <select
                                    className="form-control"
                                    value={postData.temper}
                                    onChange={(e) =>
                                        setPostData({
                                            ...postData,
                        ...
                        <div className="col-6">
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    name=""
                                    id="specNumber"
                                    value={postData.specification_number}
                                    onChange={(e) =>
                                        setPostData({
                                            ...postData,
                                            specification_number:
                        ...
                        <div className="col-6">
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    name=""
                                    id="coating_gsm"
                                    value={postData.coating_in_gsm}
                                    onChange={(e) =>
                                        setPostData({
                                            ...postData,
                                            coating_in_gsm: e.target.value,
                                        })
                                    }
                                    placeholder="Coating in GSM"
                                    className="form-control"
                                />
                            </div>
                        </div>
                        ...
                        <div className="col-12 mx-3 pr-5">
                            <label htmlFor="imageUpload">
                                ...
                                >
                                    ...
                                    <b>
                                        Select all photos in single time.{" "}
                                        <span className="text-primary">
                                            Uploading 1 image is compulsory.
                                        </span>{" "}
                                    </b>
                                </span>
                            </label>
