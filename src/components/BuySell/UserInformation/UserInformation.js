...
const UserInformation = () => {
    ...
    const savePost = async () => {
        await axios.post(`${GLOBAL_URL}/post-ads`, {
            ...
            "excel_file_link": adDetail?.excel_file_link,
            "pdf_file_link": adDetail?.pdf_file_link,
            "image_1_link": adDetail?.image_1_link,
            "image_2_link": adDetail?.image_2_link,
            "image_3_link": adDetail?.image_3_link,
            "image_4_link": adDetail?.image_4_link,
