...
const Search = () => {
    ...
    const handleSearch = async () => {
        setAdLoading(true);
        await axios.get(`${GLOBAL_URL}/ads/12?query=${search}`).then(async (response) => {
            setAd(response.data.data);
            setAdLoading(false);
        });
    };
        ...
        <div className="container-fluid py-4 px-5">
            ...
            <div className="row my-4 ">
                <div className="col-md-3">
                    <div
                        className="container rounded-lg pt-4 pb-1"
                        style={{ background: "#eeeded", fontSize: "smaller" }}
                    >
                        <div className="row ">
                                                ...
                                                {category.map((cat) => (
                                                    ...
                                                    >
                                                        <input
                                                            ...
                                                            className="custom-control-input"
                                                            id={`categoryFilter${cat.id}`}
                                                        />
                                                        <label
                                                            className="custom-control-label"
                                                            htmlFor={`categoryFilter${cat.id}`}
                                                        >
                                                            {cat.name}
                                                        </label>
                                                    </div>
